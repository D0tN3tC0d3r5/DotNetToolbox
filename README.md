...
| --- | --- | --- | --- |
| [DotNetToolbox.Core](Source/Core/README.md) | 8.0.4-rc1 | 8.0.4-rc1 | A collection of tools that implements commonly used patterns and utilities. |
| [DotNetToolbox.ObjectDumper](Source/ObjectDumper/README.md) | 8.0.4-rc1 | 8.0.4-rc1 | An extension that serializes objects into human friendly readable strings. |

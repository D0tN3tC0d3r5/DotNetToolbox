...
call Publish %target% Utilities\ValidationBuilder ValidationBuilder 8.1.1-rc1
call Publish %target% Cloud\Azure Azure 8.1.1-rc1
call Publish %target% Cloud\Http Http 8.1.1-rc1
call Publish %target% Utilities\Security Security 8.1.1-rc1

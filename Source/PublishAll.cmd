...
call Publish %target% Core\Core Core 9.0.0-alpha1
...
call Publish %target% Utilities\ValidationBuilder ValidationBuilder 9.0.0-alpha1
call Publish %target% Cloud\Azure Azure 9.0.0-alpha1
call Publish %target% Cloud\Http Http 9.0.0-alpha1
call Publish %target% Utilities\Security Security 9.0.0-alpha1
call Publish %target% AI\Core AI 9.0.0-alpha1
call Publish %target% AI\Anthropic AI.Anthropic 9.0.0-alpha1
call Publish %target% AI\OpenAI AI.OpenAI 9.0.0-alpha1
goto :eof

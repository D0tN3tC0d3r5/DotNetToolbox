...
REM call Publish %target% AI\Core AI.Core 8.1.0-rc1
REM call Publish %target% AI\Anthropic AI.Anthropic 8.1.0-rc1
REM call Publish %target% AI\OpenAI AI.OpenAI 8.1.0-rc1
goto :eof

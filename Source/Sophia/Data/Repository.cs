...
public abstract class Repository<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes)] TDomainModel>(DataContext dataContext)
    ...
    public virtual IAsyncEnumerable<TDomainModel> AsAsyncEnumerable() => this;
    public virtual IQueryable<TDomainModel> AsQueryable() => this;
    public Type ElementType => typeof(TDomainModel);
    public abstract IAsyncEnumerator<TDomainModel> GetAsyncEnumerator(CancellationToken cancellationToken = default);
    ...
    public abstract Task Update(TDomainModel input, CancellationToken ct = default);
    public abstract Task Remove(TDomainModel input, CancellationToken ct = default);
}

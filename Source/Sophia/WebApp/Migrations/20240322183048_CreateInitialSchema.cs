...
public partial class CreateInitialSchema : Migration {
    ...
    protected override void Up(MigrationBuilder builder) {
        builder.CreateTable(name: "Facts",
                            columns: table => new {
        ...
        builder.CreateTable(name: "Personas",
                            columns: table => new {
                                Id = table.Column<int>(type: "int", nullable: false).Annotation("SqlServer:Identity", "1, 1"),
        ...
        builder.CreateTable(name: "Providers",
                            columns: table => new {
                                Id = table.Column<int>(type: "int", nullable: false).Annotation("SqlServer:Identity", "1, 1"),
                                Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
        ...
        builder.CreateTable(name: "Roles",
                            columns: table => new {
        ...
        builder.CreateTable(name: "Tools",
                            columns: table => new {
                                Id = table.Column<int>(type: "int", nullable: false).Annotation("SqlServer:Identity", "1, 1"),
                                Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
        ...
        builder.CreateTable(name: "Users",
                            columns: table => new {
                                Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
        ...
        builder.CreateTable(name: "Chats",
                            columns: table => new {
                                Id = table.Column<int>(type: "int", nullable: false).Annotation("SqlServer:Identity", "1, 1"),
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_Chats_Personas_PersonaId",
        ...
        builder.CreateTable(name: "PersonaFacts",
                            columns: table => new {
                                PersonaId = table.Column<int>(type: "int", nullable: false),
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_PersonaFacts_Facts_FactId",
                                                 column: x => x.FactId,
                                                 principalTable: "Facts",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
                                table.ForeignKey(name: "FK_PersonaFacts_Personas_PersonaId",
                                                 column: x => x.PersonaId,
                                                 principalTable: "Personas",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
        ...
        builder.CreateTable(name: "Models",
                            columns: table => new {
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_Models_Providers_ProviderId",
        ...
        builder.CreateTable(name: "RoleClaims",
                            columns: table => new {
        ...
        builder.CreateTable(name: "Arguments",
                            columns: table => new {
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_Arguments_Tools_ToolId",
                                                 column: x => x.ToolId,
        ...
        builder.CreateTable(name: "PersonaTools",
                            columns: table => new {
                                PersonaId = table.Column<int>(type: "int", nullable: false),
                                ToolId = table.Column<int>(type: "int", nullable: false)
                            },
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_PersonaTools_Personas_PersonaId",
                                                 column: x => x.PersonaId,
                                                 principalTable: "Personas",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
                                table.ForeignKey(name: "FK_PersonaTools_Tools_ToolId",
                                                 column: x => x.ToolId,
                                                 principalTable: "Tools",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
        ...
        builder.CreateTable(name: "UserClaims",
                            columns: table => new {
                                Id = table.Column<int>(type: "int", nullable: false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
        ...
        builder.CreateTable(name: "UserLogins",
                            columns: table => new {
        ...
        builder.CreateTable(name: "UserProfiles",
                            columns: table => new {
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_UserProfiles_Users_Id",
                                                 column: x => x.Id,
                                                 principalTable: "Users",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
        ...
        builder.CreateTable(name: "UserRoles",
                            columns: table => new {
                                UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                                RoleId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                            },
        ...
        builder.CreateTable(name: "UserTokens",
                            columns: table => new {
                                UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                                LoginProvider = table.Column<string>(type: "nvarchar(450)", nullable: false),
        ...
        builder.CreateTable(name: "ChatMessages",
                            columns: table => new {
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_ChatMessages_Chats_ChatId",
                                                 column: x => x.ChatId,
        ...
        builder.CreateTable(name: "Worlds",
                            columns: table => new {
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_Worlds_UserProfiles_UserId",
                                                 column: x => x.UserId,
                                                 principalTable: "UserProfiles",
                                                 principalColumn: "Id");
                            });

        builder.CreateTable(name: "WorldFacts",
                            columns: table => new {
                            ...
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_WorldFacts_Facts_FactId",
                                                 column: x => x.FactId,
                                                 principalTable: "Facts",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
                                table.ForeignKey(name: "FK_WorldFacts_Worlds_WorldId",
                                                 column: x => x.WorldId,
        ...
        builder.CreateTable(name: "WorldTools",
                            columns: table => new {
                                WorldId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                                ToolId = table.Column<int>(type: "int", nullable: false)
                            },
                            constraints: table => {
                                ...
                                table.ForeignKey(name: "FK_WorldTools_Tools_ToolId",
                                                 column: x => x.ToolId,
                                                 principalTable: "Tools",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
                                table.ForeignKey(name: "FK_WorldTools_Worlds_WorldId",
                                                 column: x => x.WorldId,
                                                 principalTable: "Worlds",
                                                 principalColumn: "Id",
                                                 onDelete: ReferentialAction.Cascade);
        ...
        builder.CreateIndex(name: "IX_Chats_PersonaId",
                            table: "Chats",
                            column: "PersonaId");

        builder.CreateIndex(name: "IX_PersonaFacts_PersonaId",
                            table: "PersonaFacts",
                            column: "PersonaId");

        builder.CreateIndex(name: "IX_PersonaTools_ToolId",
                            table: "PersonaTools",
                            column: "ToolId");

        builder.CreateIndex(name: "IX_RoleClaims_RoleId",
                            table: "RoleClaims",
                            column: "RoleId");

        builder.CreateIndex(name: "RoleNameIndex",
                            table: "Roles",
                            column: "NormalizedName",
                            unique: true,
                            filter: "[NormalizedName] IS NOT NULL");

        builder.CreateIndex(name: "IX_UserClaims_UserId",
                            table: "UserClaims",
                            column: "UserId");

        builder.CreateIndex(name: "IX_UserLogins_UserId",
                            table: "UserLogins",
                            column: "UserId");

        builder.CreateIndex(name: "IX_UserRoles_RoleId",
                            table: "UserRoles",
                            column: "RoleId");

        builder.CreateIndex(name: "EmailIndex",
                            table: "Users",
                            column: "NormalizedEmail");

        builder.CreateIndex(name: "UserNameIndex",
                            table: "Users",
                            column: "NormalizedUserName",
                            unique: true,
                            filter: "[NormalizedUserName] IS NOT NULL");

        builder.CreateIndex(name: "IX_WorldFacts_WorldId",
                            table: "WorldFacts",
                            column: "WorldId");

        builder.CreateIndex(name: "IX_Worlds_UserId",
                            table: "Worlds",
                            column: "UserId",
                            unique: true,
                            filter: "[UserId] IS NOT NULL");

        builder.CreateIndex(name: "IX_WorldTools_WorldId",
                            table: "WorldTools",
                            column: "WorldId");
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder) {
        ...
        migrationBuilder.DropTable(name: "PersonaFacts");
        migrationBuilder.DropTable(name: "PersonaTools");
        ...
        migrationBuilder.DropTable(name: "WorldFacts");
        migrationBuilder.DropTable(name: "WorldTools");

...
public static partial class AsyncQueryableExtensions {
    public static ValueTask<bool> SequenceEqualAsync<TItem>(this IAsyncQueryable<TItem> first, IEnumerable<TItem> second, CancellationToken ct = default)
        => first.SequenceEqualAsync(second, EqualityComparer<TItem>.Default, ct);

    public static async ValueTask<bool> SequenceEqualAsync<TItem>(this IAsyncQueryable<TItem> first, IEnumerable<TItem> second, IEqualityComparer<TItem> comparer, CancellationToken ct = default) {

...
public static partial class AsyncQueryableExtensions {
    ...
    public static ValueTask<HashSet<TResult>> ToHashSetAsync<TItem, TResult>(this IAsyncQueryable<TItem> source, Expression<Func<TItem, TResult>> mapping, CancellationToken ct = default)
        => IsNotNull(source).Select(mapping).MakeHashSetAsync(EqualityComparer<TResult>.Default, ct);

    public static ValueTask<HashSet<TResult>> ToHashSetAsync<TItem, TResult>(this IAsyncQueryable<TItem> source, Expression<Func<TItem, TResult>> mapping, IEqualityComparer<TResult> comparer, CancellationToken ct = default)
        => IsNotNull(source).Select(mapping).MakeHashSetAsync(comparer, ct);

    public static ValueTask<HashSet<TResult>> ToHashSetAsync<TItem, TResult>(this IAsyncQueryable<TItem> source, Expression<Func<TItem, int, TResult>> mapping, CancellationToken ct = default)
        => IsNotNull(source).Select(mapping).MakeHashSetAsync(EqualityComparer<TResult>.Default, ct);

    public static ValueTask<HashSet<TResult>> ToHashSetAsync<TItem, TResult>(this IAsyncQueryable<TItem> source, Expression<Func<TItem, int, TResult>> mapping, IEqualityComparer<TResult> comparer, CancellationToken ct = default)
        => IsNotNull(source).Select(mapping).MakeHashSetAsync(comparer, ct);

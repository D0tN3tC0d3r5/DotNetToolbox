...
public static partial class AsyncQueryableExtensions {
    public static async ValueTask<TItem?> ElementAtAsync<TItem>(this IQueryable<TItem> source, int index, CancellationToken cancellationToken = default) {
        IsNotNegative(index);
        var count = 0;
    ...
    public static async ValueTask<TItem?> ElementAtAsync<TItem>(this IQueryable<TItem> source, Index index, CancellationToken cancellationToken = default) {
        if (!index.IsFromEnd)

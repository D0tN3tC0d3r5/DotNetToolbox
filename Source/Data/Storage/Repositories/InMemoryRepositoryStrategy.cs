...
internal sealed class InMemoryRepositoryStrategy<TRepository, TItem>
    ...
    public override TItem FirstOrDefault(Expression<Func<TItem, bool>> predicate, TItem defaultValue)
    ...
    public override void Add(TItem newItem) => _data.Add(newItem);

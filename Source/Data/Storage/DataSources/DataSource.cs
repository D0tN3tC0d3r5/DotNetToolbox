...
public class DataSource<TStorage, TItem, TKey>
    ...
    public DataSource(TStorage strategy, IEnumerable<TItem>? records = null)
        : base(strategy, records) {
    }
...
public class DataSource<TStrategy, TItem>
    ...
    public DataSource(TStrategy strategy, IEnumerable<TItem>? records = null)
        : base(records) {
